...
function App() {
    ...
    return (
        <div className="App">
            <Todolist title={title} tasks={filteredTasks} filterValue={filterValue} removeTask={removeTask} changeFilter={changeFilter} addTask={addTask} changeStatus={changeStatus} />
        </div>
    );
}
